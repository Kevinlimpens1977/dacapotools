-- DaCapo Toolbox Database Schema
-- Uitvoeren op MySQL database: dacapo_apps

-- Drop bestaande tabellen als ze bestaan (voor clean install)
-- LET OP: Commenteer deze regels uit als je data wilt behouden!
...
-- Voorbeeld apps (optioneel - commentaar weg voor test data)
...
-- Toon aantal apps per categorie
SELECT category, COUNT(*) as aantal FROM apps GROUP BY category;
